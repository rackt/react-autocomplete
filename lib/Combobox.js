...
var Combobox = React.createClass({
  ...
  componentWillMount: function() {
    this.setState({menu: this.getMenuForChildren(this.props.children)});
  },

  componentWillReceiveProps: function(newProps) {
    this.setState({menu: this.getMenuForChildren(newProps.children)});
  },
  ...
  */
  getMenuForChildren: function(children) {
    var activeChildId;
    var isEmpty = true;
  ...
  */
  ...
  render: function() {
    ...
    return (
      <div className={joinClasses(this.getClassName(), className)}>
        <input
          ref="input"
