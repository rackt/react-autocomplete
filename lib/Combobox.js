...
var Combobox = React.createClass({
  ...
  handleRequestSelect: function() {
    var value = this.state.options[this.props.value.focusedIndex];
  ...
  handleRequestFocus: function(index) {
  ...
  handleRequestFocusNext: function() {
    var {focusedIndex} = this.props.value;
    var lastIndex = this.state.options.length - 1;
    var nextIndex = (focusedIndex == null || focusedIndex >= lastIndex)
                  ? 0 : focusedIndex + 1;
  ...
  handleRequestFocusPrevious: function() {
    var {focusedIndex} = this.props.value;
    var lastIndex = this.state.options.length - 1;
    var previousIndex = (focusedIndex == null || focusedIndex <= 0)
                      ? lastIndex : focusedIndex - 1
  ...
  render: function() {
    ...
    var selectedLabel = value.focusedIndex != null 
      ? this.props.getLabelForValue(this.state.options[value.focusedIndex])
      : null;
