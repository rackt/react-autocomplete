...
class Autocomplete extends React.Component {
  ...
  static defaultProps = {
    ...
    renderMenu(items, value, style) {
      return <div role="listbox" style={{ ...style, ...this.menuStyle }} children={items}/>
    },
    menuStyle: {
      borderRadius: '3px',
  ...
  render() {
    ...
    return (
      <div style={{ ...this.props.wrapperStyle }} {...this.props.wrapperProps} role="combobox" aria-expanded={open}>
