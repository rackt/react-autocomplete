...
const { faTimesCircle } = require('@fortawesome/free-solid-svg-icons')
...
class Autocomplete extends React.Component {
  ...
  renderClearButton() {
    ...
    return <span style={wrapperStyle} ><FontAwesomeIcon style={iconStyle} onClick={this.handleClear} icon="times-circle" /></span>
  }
