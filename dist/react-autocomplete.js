  ...
  _createClass(Autocomplete, [{
    ...
    value: function render() {
      ...
      return React.createElement(
        'div',
        _extends({ style: _extends({}, this.props.wrapperStyle) }, this.props.wrapperProps, { role: 'combobox', 'aria-expanded': open }),
...
Autocomplete.defaultProps = {
  ...
  renderMenu: function renderMenu(items, value, style) {
    return React.createElement('div', { role: 'listbox', style: _extends({}, style, this.menuStyle), children: items });
  },
